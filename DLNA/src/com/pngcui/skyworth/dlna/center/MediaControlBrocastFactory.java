...
public class MediaControlBrocastFactory {
	...
	public static final String MEDIA_RENDERER_CMD_PLAY="com.pngcui.control.play_command";
	public static final String MEDIA_RENDERER_CMD_PAUSE="com.pngcui.control.pause_command";
	public static final String MEDIA_RENDERER_CMD_STOP="com.pngcui.control.stop_command";
	public static final String MEDIA_RENDERER_CMD_SEEKPS="com.pngcui.control.seekps_command";
